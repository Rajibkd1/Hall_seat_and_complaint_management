    ...
    <div class="p-8 lg:p-12">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-12">
                ...
                <h2 class="text-4xl font-bold text-slate-800 mb-4 tracking-tight">Welcome to Dashboard</h2>
                <p class="text-xl text-slate-600 leading-relaxed">Your central hub for hall management and services</p>
            </div>
