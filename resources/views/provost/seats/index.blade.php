...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 pt-20">
        ...
        <div class="fixed inset-0 overflow-hidden pointer-events-none">
            <div
                class="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-blue-200/30 to-slate-300/20 rounded-full blur-3xl animate-float">
            </div>
            <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-slate-200/30 to-blue-300/20 rounded-full blur-3xl animate-float"
                style="animation-delay: -2s;"></div>
        </div>

        <!-- Compact Header Section -->
        <div class="relative bg-white/95 backdrop-blur-sm border-b border-blue-200/50 py-3 px-4 shadow-sm">
            <div class="container mx-auto">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="space-y-1">
                        ...
                        <p class="text-gray-600 text-xs sm:text-sm font-medium">Provost hall seat visualization and
                            management</p>
                    </div>
                    <div class="hidden lg:block">
                        <div class="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-blue-200/50 shadow-lg">
                            <div class="flex items-center space-x-4 text-xs">
                                ...
                                <div class="w-px h-6 bg-gradient-to-b from-transparent via-blue-300 to-transparent"></div>
                                <div class="text-center group">
                                    <div class="text-sm font-bold text-slate-900 mb-0.5 group-hover:scale-105 transition-transform duration-300"
        ...
        <div class="container mx-auto px-4 py-4 sm:py-8 relative">
            ...
            <div
                class="relative bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border border-blue-200/50 p-4 sm:p-8 mb-6 sm:mb-8 overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-50/50 to-slate-50/50"></div>
                <div class="relative flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-4 sm:gap-8">
                    ...
                    <div class="flex items-center gap-3 sm:gap-4 group">
                        <div
                            class="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-100 to-slate-200 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-5 h-5 sm:w-7 sm:h-7 text-blue-700" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                        ...
                        <div class="flex-1">
                            ...
                            <select id="floor"
                                class="form-select w-full border-2 border-blue-200 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-6 sm:py-3 bg-white/80 backdrop-blur-sm focus:border-blue-400 focus:ring-0 transition-all duration-300 font-semibold text-slate-800 shadow-lg text-sm sm:text-base">
            ...
            <!-- Enhanced Legend -->
            <div
                class="relative bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl border border-blue-200/50 p-4 sm:p-8 mb-6 sm:mb-8 overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-50/30 to-slate-50/30"></div>
                <div class="relative">
                    <h3 class="text-lg sm:text-2xl font-black text-slate-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                        <div
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-slate-800 rounded-xl sm:rounded-2xl flex items-center justify-center">
                        ...
                        <span class="bg-gradient-to-r from-blue-800 to-slate-900 bg-clip-text text-transparent">Status
                            Legend</span>
                    </h3>
                    <div class="flex flex-wrap gap-3 sm:gap-6">
                        <div
                            class="flex items-center gap-2 sm:gap-4 bg-white/80 backdrop-blur-sm px-3 py-2 sm:px-6 sm:py-4 rounded-xl sm:rounded-2xl border border-blue-200/50 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            <div
                        ...
                        <div
                            class="flex items-center gap-2 sm:gap-4 bg-white/80 backdrop-blur-sm px-3 py-2 sm:px-6 sm:py-4 rounded-xl sm:rounded-2xl border border-blue-200/50 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            <div
                                class="w-6 h-6 sm:w-8 sm:h-8 bg-white border-2 border-blue-400 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                            </div>
                            <span
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div
                    class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-blue-100 p-4 sm:p-6 hover:shadow-md transition-all duration-300">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-8 h-8 sm:w-12 sm:h-12 bg-blue-900 rounded-lg sm:rounded-xl flex items-center justify-center">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-8 h-8 sm:w-12 sm:h-12 bg-blue-700 rounded-lg sm:rounded-xl flex items-center justify-center">
                            <svg class="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-8 h-8 sm:w-12 sm:h-12 bg-blue-500 rounded-lg sm:rounded-xl flex items-center justify-center">
                            <svg class="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-8 h-8 sm:w-12 sm:h-12 bg-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center">
                            <svg class="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
            ...
            <!-- Room Grid -->
            <div id="roomGrid" class="bg-white rounded-lg shadow-sm p-4 sm:p-8 border border-blue-200">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3">
                    <h2 id="gridTitle"
                        ...
                        <div
                            class="w-6 h-6 sm:w-8 sm:h-8 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 text-xs sm:text-sm font-bold">
                            1</div>
                        Floor 1 - Front Block
                    </h2>
                    <div class="hidden sm:flex items-center gap-2 text-sm text-gray-600 bg-blue-50 px-3 py-2 rounded-lg">
            ...
            <div id="seatGrid"
                class="bg-white rounded-lg shadow-sm p-4 sm:p-8 mt-6 sm:mt-8 border border-blue-200 hidden">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-4">
                    ...
                    <button id="backToRooms"
                        class="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
