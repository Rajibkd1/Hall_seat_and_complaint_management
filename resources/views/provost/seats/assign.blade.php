            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    @if ($availableStudents->count() > 0)
                        ...
                        <div class="mb-6">
                            <div class="relative">
                                <input type="text" id="studentSearch"
                                    placeholder="Search students by name, email, or application details..."
                        ...
                        <!-- Assignment Form -->
                        <form id="seatAssignmentForm" action="{{ route('provost.seats.assign') }}" method="POST"
                            class="space-y-6">
                            @csrf
                            ...
                            <div id="studentListContainer"
                                class="max-h-96 overflow-y-auto border border-gray-300 rounded-lg bg-white">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-4 flex-1">
                                                ...
                                                <div class="flex-shrink-0">
                                                    ...
                                                    @else
                                                        <div
                                                            class="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 text-sm font-medium border-2 border-gray-200">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-sm text-gray-600 mb-1">
                                                        {{ $application->student->email ?? 'N/A' }}</div>
                                                    <div class="text-xs text-gray-500">Application ID:
                                                        {{ $application->application_id }}</div>
                                                    <div class="text-xs text-gray-500">Department:
                                                        {{ $application->department }}</div>
                                                </div>
                                            </div>

                                            <!-- Academic Information -->
                                            <div class="text-right ml-4">
                                                <div class="text-sm font-medium text-gray-700">CGPA:
                                                    {{ $application->cgpa }}</div>
                            ...
                            <div id="selectedStudentDisplay"
                                class="p-4 bg-gray-50 border border-gray-300 rounded-lg hidden">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center text-white text-sm">
                                        ✓</div>
                                    <div>
                    ...
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            <div class="text-gray-500 mb-6">There are currently no approved applications available for seat
                                assignment.</div>
                            <a href="{{ route('provost.seats.index') }}"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                studentItems.forEach(item => {
                    item.addEventListener('click', function() {
                        ...
                        if (previousSelected) {
                            previousSelected.classList.remove('selected', 'bg-gray-100',
                                'border-gray-400');
                        ...
                        selectedStudentDetails.textContent =
                            `${studentEmail} • Application ID: ${applicationId}`;
            ...
            `;
                ...
                seatAssignmentForm.addEventListener('submit', function(e) {
                    ...
                    assignSeatBtn.innerHTML =
                        '<div class="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div> Assigning...';
