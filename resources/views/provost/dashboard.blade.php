...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden pt-20">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-indigo-400/10 to-blue-400/10 rounded-full blur-3xl"></div>
    </div>

    <!-- Welcome Section with Provost Details -->
            ...
            <div class="flex flex-col items-center text-center lg:flex-row lg:text-left lg:items-center lg:justify-between">
                <div class="flex-1 mb-8 lg:mb-0 lg:pr-8">
                    ...
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-light mb-4 sm:mb-6 animate-fade-in leading-tight">
                        ...
                        <span class="bg-gradient-to-r from-blue-200 to-indigo-200 bg-clip-text text-transparent font-medium">{{ $admin->name }}</span>
                    </h1>
                    
                    <!-- Provost Details - Hidden on Mobile (<640px), Visible on Tablet+ (≥640px) -->
                    <div class="hidden sm:flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:gap-6 text-sm sm:text-base lg:text-lg">
                        ...
                        <div class="flex items-center justify-center lg:justify-start group bg-slate-700/40 backdrop-blur-sm rounded-lg px-4 py-3 border border-slate-600/30 hover:bg-slate-700/50 transition-all duration-300">
                            <div class="p-2 bg-indigo-500/20 rounded-lg mr-3 group-hover:bg-indigo-500/30 transition-all duration-300">
                                <i class="fas fa-crown text-indigo-200 flex-shrink-0"></i>
                            </div>
                            <div>
                                <p class="text-xs text-indigo-200 uppercase tracking-wider mb-1">Role</p>
                                <span class="text-white font-medium truncate">Provost</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-center lg:justify-start group bg-slate-700/40 backdrop-blur-sm rounded-lg px-4 py-3 border border-slate-600/30 hover:bg-slate-700/50 transition-all duration-300">
                            <div class="p-2 bg-purple-500/20 rounded-lg mr-3 group-hover:bg-purple-500/30 transition-all duration-300">
                                <i class="fas fa-building text-purple-200 flex-shrink-0"></i>
                            </div>
                            <div>
                                <p class="text-xs text-purple-200 uppercase tracking-wider mb-1">Hall</p>
                        ...
                        @if($admin->department)
                        <div class="flex items-center justify-center lg:justify-start group bg-slate-700/40 backdrop-blur-sm rounded-lg px-4 py-3 border border-slate-600/30 hover:bg-slate-700/50 transition-all duration-300">
                            <div class="p-2 bg-cyan-500/20 rounded-lg mr-3 group-hover:bg-cyan-500/30 transition-all duration-300">
                                <i class="fas fa-university text-cyan-200 flex-shrink-0"></i>
                            </div>
                            <div>
                                <p class="text-xs text-cyan-200 uppercase tracking-wider mb-1">Department</p>
                                <span class="text-white font-medium">{{ $admin->department }}</span>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="hidden sm:block flex-shrink-0">
                    <div class="relative group">
                        ...
                        <div class="absolute -bottom-2 -right-2 w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full border-4 border-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
    ...
    <div class="container mx-auto px-4 sm:px-6 -mt-8 relative z-10">
        <!-- Statistics Cards -->
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-12">
            <div class="stat-card group bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl p-4 sm:p-6 border border-slate-200/50 hover:border-blue-300/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 relative overflow-hidden">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="mb-3 sm:mb-0">
                        ...
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 group-hover:text-blue-600 transition-colors duration-300">{{ $stats['students'] ?? 0 }}</p>
                    </div>
                    <div class="self-end sm:self-auto">
                        <div class="p-3 sm:p-4 bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl group-hover:from-blue-500 group-hover:to-blue-600 transition-all duration-300">
                            <i class="fas fa-users text-xl sm:text-2xl text-blue-600 group-hover:text-white transition-colors duration-300"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card group bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl p-4 sm:p-6 border border-slate-200/50 hover:border-emerald-300/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 relative overflow-hidden">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="mb-3 sm:mb-0">
                        ...
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 group-hover:text-emerald-600 transition-colors duration-300">{{ $stats['co_provosts'] ?? 0 }}</p>
                    </div>
                    <div class="self-end sm:self-auto">
            ...
            <div class="stat-card group bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl p-4 sm:p-6 border border-slate-200/50 hover:border-purple-300/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 relative overflow-hidden">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="mb-3 sm:mb-0">
                        ...
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 group-hover:text-purple-600 transition-colors duration-300">{{ $stats['staff'] ?? 0 }}</p>
                    </div>
                    <div class="self-end sm:self-auto">
                        <div class="p-3 sm:p-4 bg-gradient-to-br from-purple-100 to-purple-50 rounded-xl group-hover:from-purple-500 group-hover:to-purple-600 transition-all duration-300">
                            <i class="fas fa-users-cog text-xl sm:text-2xl text-purple-600 group-hover:text-white transition-colors duration-300"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card group bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl p-4 sm:p-6 border border-slate-200/50 hover:border-red-300/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 relative overflow-hidden">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="mb-3 sm:mb-0">
                        <p class="text-xs sm:text-sm font-semibold text-slate-500 uppercase tracking-wider mb-1">Active Complaints</p>
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 group-hover:text-red-600 transition-colors duration-300">{{ $stats['active_complaints'] ?? 0 }}</p>
                    </div>
                    <div class="self-end sm:self-auto">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="flex items-center space-x-3 p-4 bg-blue-50/50 rounded-lg border border-blue-200/50">
                        ...
                        <span class="text-slate-700 font-medium">Full administrative control</span>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-blue-50/50 rounded-lg border border-blue-200/50">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-check text-blue-600"></i>
                    ...
                    <div class="flex items-center space-x-3 p-4 bg-blue-50/50 rounded-lg border border-blue-200/50">
                        ...
                        <span class="text-slate-700 font-medium">Create Co-Provosts & Staff</span>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-blue-50/50 rounded-lg border border-blue-200/50">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-check text-blue-600"></i>
                        </div>
                        <span class="text-slate-700 font-medium">Manage all applications</span>
                    </div>
                    <div class="flex items-center space-x-3 p-4 bg-blue-50/50 rounded-lg border border-blue-200/50">
                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                            <i class="fas fa-check text-blue-600"></i>
                        </div>
                        <span class="text-slate-700 font-medium">Handle all complaints</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-slate-200/50 p-6 sm:p-8 mb-12 relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
                    <a href="{{ \App\Helpers\RouteHelper::getRoleBasedRoute('students') }}" class="action-btn group bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl p-4 sm:p-6 text-center transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl relative overflow-hidden">
                    ...
                    <a href="{{ \App\Helpers\RouteHelper::getRoleBasedRoute('complaints') }}" class="action-btn group bg-gradient-to-br from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl p-4 sm:p-6 text-center transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl relative overflow-hidden">
                    ...
                    <a href="{{ \App\Helpers\RouteHelper::getRoleBasedRoute('notices.create') }}" class="action-btn group bg-gradient-to-br from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-xl p-4 sm:p-6 text-center transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl relative overflow-hidden">
                    ...
                    <a href="{{ \App\Helpers\RouteHelper::getRoleBasedRoute('seats.index') }}" class="action-btn group bg-gradient-to-br from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-xl p-4 sm:p-6 text-center transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl relative overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-r from-violet-500/20 to-indigo-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative">
                            <div class="p-3 bg-white/10 rounded-lg mb-3 mx-auto w-fit group-hover:bg-white/20 transition-all duration-300">
                    ...
                    <a href="{{ \App\Helpers\RouteHelper::getRoleBasedRoute('create_admin') }}" class="action-btn group bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-xl p-4 sm:p-6 text-center transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-2xl relative overflow-hidden">
        ...
        <!-- Management Overview -->
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-slate-200/50 p-6 sm:p-8 mb-12 relative overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-r from-indigo-500/5 via-blue-500/5 to-purple-500/5"></div>
            <div class="relative">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-xl sm:text-2xl font-bold text-slate-800 flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center p-6 bg-gradient-to-br from-indigo-50/80 to-indigo-25/50 rounded-xl border border-indigo-200/50 hover:shadow-md transition-all duration-300">
                        <div class="w-16 h-16 bg-gradient-to-br from-indigo-100 to-indigo-50 rounded-full flex items-center justify-center mx-auto mb-4">
                            <i class="fas fa-university text-indigo-600 text-2xl"></i>
                        </div>
                        <p class="font-semibold text-slate-800 mb-2">Department</p>
                        <p class="text-slate-600">{{ $admin->department ?? 'Administration' }}</p>
                    </div>
                    <div class="text-center p-6 bg-gradient-to-br from-green-50/80 to-green-25/50 rounded-xl border border-green-200/50 hover:shadow-md transition-all duration-300">
                        ...
                        <p class="text-green-600 font-semibold">Active & Verified</p>
                    </div>
                </div>
            </div>
        </div>
