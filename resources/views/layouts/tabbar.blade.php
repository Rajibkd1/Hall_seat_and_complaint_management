<div id="tabBar" class="hidden lg:block bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200/50">
    <div class="container mx-auto px-6">
        <ul class="flex justify-evenly overflow-x-auto">
            <li><a href="{{ route('student.dashboard') }}" class="tab-link group flex flex-col items-center justify-center text-slate-700 py-6 px-8 font-medium transition-all duration-300 hover:bg-gradient-to-b hover:from-slate-50 hover:to-slate-100 border-b-3 border-slate-600 min-w-[120px] rounded-t-xl">
            ...
            <li><a href="{{ route('student.hall-notice') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-6 px-8 font-medium hover:text-slate-700 hover:bg-gradient-to-b hover:from-slate-50 hover:to-slate-100 transition-all duration-300 border-b-3 border-transparent hover:border-slate-300 min-w-[120px] rounded-t-xl">
                <div class="bg-slate-100 p-3 rounded-xl mb-2 group-hover:bg-slate-200 transition-all duration-300 group-hover:scale-110">
                    <i class="fas fa-bullhorn text-xl text-slate-500 group-hover:text-slate-600"></i>
                </div>
                <span class="text-sm font-medium">Notices</span>
            </a></li>
            <li><a href="{{ route('student.seat_application') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-6 px-8 font-medium hover:text-slate-700 hover:bg-gradient-to-b hover:from-slate-50 hover:to-slate-100 transition-all duration-300 border-b-3 border-transparent hover:border-slate-300 min-w-[120px] rounded-t-xl">
                <div class="bg-slate-100 p-3 rounded-xl mb-2 group-hover:bg-slate-200 transition-all duration-300 group-hover:scale-110">
                    <i class="fas fa-chair text-xl text-slate-500 group-hover:text-slate-600"></i>
                </div>
                <span class="text-sm font-medium">Seat Apply</span>
            </a></li>
            <li><a href="{{ route('student.complaint_list') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-6 px-8 font-medium hover:text-slate-700 hover:bg-gradient-to-b hover:from-slate-50 hover:to-slate-100 transition-all duration-300 border-b-3 border-transparent hover:border-slate-300 min-w-[120px] rounded-t-xl">
                <div class="bg-slate-100 p-3 rounded-xl mb-2 group-hover:bg-slate-200 transition-all duration-300 group-hover:scale-110">
            ...
            <li><a href="{{ route('student.contact_us') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-6 px-8 font-medium hover:text-slate-700 hover:bg-gradient-to-b hover:from-slate-50 hover:to-slate-100 transition-all duration-300 border-b-3 border-transparent hover:border-slate-300 min-w-[120px] rounded-t-xl">
                <div class="bg-slate-100 p-3 rounded-xl mb-2 group-hover:bg-slate-200 transition-all duration-300 group-hover:scale-110">
