<div id="tabBar" class="hidden lg:block bg-gradient-to-r from-white/90 via-white/95 to-white/90 backdrop-blur-xl shadow-lg border-b border-gray-200/60 relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <ul class="flex justify-evenly overflow-x-auto">
            <!-- Dashboard Tab -->
            <li class="relative">
                <a href="{{ route('student.dashboard') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'dashboard' ? 'active-tab-indicator' : 'border-transparent' }}">
                    <!-- Shimmer effect -->
            ...
            <!-- Profile Tab -->
            <li class="relative">
                <a href="{{ route('student.profile') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'profile' ? 'active-tab-indicator' : 'border-transparent' }}">
                    ...
                    <div class="bg-gradient-to-br from-blue-100 to-blue-50 px-4 py-2 rounded-md mb-2 group-hover:bg-gradient-to-br group-hover:from-blue-200 group-hover:to-blue-100 transition-all duration-500 shadow-md group-hover:shadow-xl relative z-10">
                        <i class="fas fa-user text-lg text-blue-600 group-hover:text-blue-800 transition-colors duration-300 drop-shadow-sm"></i>
                    </div>
                    <span class="text-xs font-semibold group-hover:text-slate-800 transition-all duration-300 relative z-10">Profile</span>
                </a>
            </li>

            <!-- Notices Tab -->
            <li class="relative">
                <a href="{{ route('student.hall-notice') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'hall_notices' ? 'active-tab-indicator' : 'border-transparent' }}">
            ...
            <!-- Seat Apply Tab -->
            <li class="relative">
                <a href="{{ route('student.seat_application') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'seat_application' ? 'active-tab-indicator' : 'border-transparent' }}">
                    ...
                    <div class="bg-gradient-to-br from-purple-100 to-purple-50 px-4 py-2 rounded-md mb-2 group-hover:bg-gradient-to-br group-hover:from-purple-200 group-hover:to-purple-100 transition-all duration-500 shadow-md group-hover:shadow-xl relative z-10">
                        <i class="fas fa-chair text-lg text-purple-600 group-hover:text-purple-800 transition-colors duration-300 drop-shadow-sm"></i>
                    </div>
                    <span class="text-xs font-semibold group-hover:text-slate-800 transition-all duration-300 relative z-10">Seat Apply</span>
                </a>
            </li>

            <!-- Complaints Tab -->
            <li class="relative">
                <a href="{{ route('student.complaint_list') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'complaint_list' ? 'active-tab-indicator' : 'border-transparent' }}">
            ...
            <!-- Contact Tab -->
            <li class="relative">
                <a href="{{ route('student.contact_us') }}" class="tab-link group flex flex-col items-center justify-center text-slate-600 py-3 px-6 font-medium transition-all duration-500 border-b-4 min-w-[100px] rounded-t-md relative overflow-hidden {{ session('active_nav') === 'contact_us' ? 'active-tab-indicator' : 'border-transparent' }}">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-teal-200/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                    <div class="bg-gradient-to-br from-teal-100 to-teal-50 px-4 py-2 rounded-md mb-2 group-hover:bg-gradient-to-br group-hover:from-teal-200 group-hover:to-teal-100 transition-all duration-500 shadow-md group-hover:shadow-xl relative z-10">
                        <i class="fas fa-phone text-lg text-teal-600 group-hover:text-teal-800 transition-colors duration-300 drop-shadow-sm"></i>
                    </div>
                    <span class="text-xs font-semibold group-hover:text-slate-800 transition-all duration-300 relative z-10">Contact</span>
                </a>
            </li>
