                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-4 space-x-4">
                                ...
                                <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                                    ...
                                    <div class="text-white text-lg font-semibold">{{ \Carbon\Carbon::parse($allotment->start_date)->format('M j, Y') }}</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                        <div class="flex items-center space-x-6">
                            <div class="relative">
                                ...
                                @else
                                    <div class="w-24 h-24 rounded-lg bg-gray-300 flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-lg">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="font-medium">{{ $allotment->student->email ?? 'No email provided' }}</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="font-bold text-lg text-blue-600 bg-blue-50 px-3 py-1 rounded-full font-mono">{{ $allotment->student->university_id ?? 'N/A' }}</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="font-medium">{{ $allotment->application->academic_year ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 lg:mt-0">
                            <div class="text-right">
                                ...
                                <span class="inline-flex items-center px-4 py-2 rounded-lg text-lg font-bold shadow-lg bg-green-500 text-white">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Room Number</span>
                                <span class="text-sm font-bold text-gray-900">{{ $allotment->seat->room_number ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Bed Number</span>
                                <span class="text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">{{ $allotment->seat->bed_number ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Block</span>
                                <span class="text-sm font-bold text-gray-900">{{ $allotment->seat->block ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Floor</span>
                                <span class="text-sm font-bold text-gray-900">{{ $allotment->seat->floor ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Seat Status</span>
                                <span class="text-sm font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full">{{ ucfirst($allotment->seat->status ?? 'N/A') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Allocated By</span>
                                <span class="text-sm font-bold text-gray-900">{{ $allotment->admin->name ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Admin Role</span>
                                <span class="text-sm font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full">{{ ucfirst($allotment->admin->role ?? 'Admin') }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Start Date</span>
                                <span class="text-sm font-bold text-gray-900">{{ \Carbon\Carbon::parse($allotment->start_date)->format('F j, Y') }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                            ...
                            <div class="flex justify-between items-center py-3">
                                ...
                                <span class="text-sm font-bold text-gray-900">{{ \Carbon\Carbon::parse($allotment->start_date)->diffForHumans() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Application ID</span>
                                <span class="text-sm font-bold text-purple-600 bg-purple-50 px-3 py-1 rounded-full">#{{ $allotment->application->application_id ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Program</span>
                                <span class="text-sm font-bold text-gray-900">{{ ucfirst($allotment->application->program ?? 'N/A') }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">CGPA</span>
                                <span class="text-sm font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full">{{ $allotment->application->cgpa ?? 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Application Date</span>
                                <span class="text-sm font-bold text-gray-900">{{ $allotment->application ? \Carbon\Carbon::parse($allotment->application->application_date)->format('F j, Y') : 'N/A' }}</span>
                            </div>
                            <div class="flex justify-between items-center py-3">
                                <span class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Application Status</span>
                                <span class="text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">{{ ucfirst($allotment->application->status ?? 'N/A') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
