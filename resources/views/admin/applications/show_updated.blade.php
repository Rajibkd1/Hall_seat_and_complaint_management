...
<div class="min-h-screen bg-gray-100 p-8">
    <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200 mt-8">
            ...
            <form action="{{ route('admin.applications.update_status', $application->application_id) }}" method="POST" class="max-w-2xl">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-4">
                    ...
                    <textarea 
                        ...
                        placeholder="Enter a message to explain the status change or provide additional information..."
                        maxlength="2000"
                    ></textarea>
                ...
                <div class="flex items-center">
                    <button type="submit" class="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition ease-in-out duration-150">
                        <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <div class="ml-4 text-sm text-gray-600">
                        <label class="inline-flex items-center">
                            <input type="checkbox" id="sendEmail" name="send_email" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" checked>
