        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8 p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="block-filter" class="block text-sm font-medium text-gray-700 mb-2">Filter by
                            Block</label>
                    ...
                    <div>
                        <label for="floor-filter" class="block text-sm font-medium text-gray-700 mb-2">Filter by
                            Floor</label>
