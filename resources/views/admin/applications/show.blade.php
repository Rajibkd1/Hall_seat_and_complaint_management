                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="text-right">
                            ...
                            <a href="{{ route('admin.applications.download_pdf', $application->application_id) }}"
                                class="inline-flex items-center px-4 py-2 bg-blue-600 border border-blue-500 text-white font-medium rounded-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors duration-200 ml-2">
                                <svg class="-ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
                            ...
                            <div class="p-6">
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        ...
                                        <span
                                            class="text-sm font-bold text-gray-900">{{ $application->student_name }}</span>
                                    </div>
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                    ...
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        ...
                                        <span
                                            class="text-sm font-bold text-gray-900">{{ $application->academic_year }}</span>
                                    </div>
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <div class="p-6">
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                        ...
                                        <span
                                            class="text-sm font-bold text-gray-900">{{ $application->guardian_name }}</span>
                                    </div>
                                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <div class="p-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div class="text-center">
                                        <h4 class="text-lg font-bold text-gray-800 mb-4 flex items-center justify-center">
                                            <svg class="w-5 h-5 mr-2 text-gray-600" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                        ...
                                        @if ($application->student->id_card_front)
                                            ...
                                            <p
                                                class="text-sm text-green-600 font-medium mt-3 flex items-center justify-center">
                            ...
                            @else
                                <div class="text-center py-12">
                                    ...
                                    <p class="text-xl text-gray-500 font-semibold mb-2">Student Information Not Available
                                    </p>
                                ...
                                @foreach ($documents as $field => $doc)
                                    @if (!empty($application->{$field}))
                                        <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 text-center">
                                            ...
                                            <h4 class="font-bold text-gray-800 text-center mb-3 text-sm">
                                                {{ $doc['name'] }}
                                            </h4>
                                    ...
                                    @else
                                        <div
                                            ...
                                            <h4 class="font-bold text-gray-600 text-center mb-2 text-sm">
                                                {{ $doc['name'] }}
                                            </h4>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="p-6">
                                <form
                                    action="{{ route('admin.applications.update_status', $application->application_id) }}"
                                    method="POST" class="space-y-6">
                                    @csrf
                                    @method('PATCH')

                                    <div>
                                        <label for="status" class="block text-sm font-bold text-gray-700 mb-3">Select
                                            New
                                            Status</label>
                                        <select name="status" id="status"
                                            ...
                                            <option value="approved"
                                                {{ $application->status === 'approved' ? 'selected' : '' }}>Approved
                                            </option>
                                    ...
                                    <div>
                                        <label for="email_message"
                                            class="block text-sm font-bold text-gray-700 mb-3">Message
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
                        <div class="bg-gray-700 px-8 py-6">
                            ...
                            <p class="text-gray-300 mt-2">Complete history of all status changes and administrative actions
                            </p>
                        </div>
                        <div class="p-8">
                            @if ($application->auditLogs && $application->auditLogs->count() > 0)
                                <div class="space-y-6">
                                    @foreach ($application->auditLogs->sortByDesc('created_at') as $log)
                                        <div
                                            class="relative pl-8 pb-6 border-l-4 border-gray-400 last:border-l-0 last:pb-0">
                                            <div
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-6 ml-4">
                                                <div class="flex justify-between items-start">
                                                    <div class="flex-1">
                                                        ...
                                                        @if ($log->message)
                                                            <div
                                                                class="bg-white rounded-lg p-4 border border-gray-200 mt-3">
                ...
                <div class="mt-3 text-center">
                    ...
                    <div class="items-center px-4 py-3">
                        <button id="closeModal"
                            class="px-4 py-2 bg-gray-700 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            Close
                        </button>
                    </div>
                </div>
