    ...
    <div class="container mx-auto p-6">
            ...
            <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-4 md:p-6 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl md:text-3xl font-bold">{{ $applications->where('status', 'pending')->count() }}</p>
                    </div>
                    <div class="w-8 h-8 md:w-12 md:h-12 bg-white/20 rounded-full flex items-center justify-center">
                        <svg class="w-4 h-4 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 md:p-6 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl md:text-3xl font-bold">{{ $applications->where('status', 'approved')->count() }}</p>
                    </div>
                    <div class="w-8 h-8 md:w-12 md:h-12 bg-white/20 rounded-full flex items-center justify-center">
                        <svg class="w-4 h-4 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-4 md:p-6 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl md:text-3xl font-bold">{{ $applications->where('status', 'rejected')->count() }}</p>
                    </div>
                    <div class="w-8 h-8 md:w-12 md:h-12 bg-white/20 rounded-full flex items-center justify-center">
                        <svg class="w-4 h-4 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($applications as $index => $application)
                            <tr class="hover:bg-gray-50 transition-colors duration-150"
                                ...
                                <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    {{ $index + 1 }}
                                </td>
                                ...
                                <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-center">
                                    <a href="{{ route('admin.applications.view', $application->application_id) }}"
                                        ...
                                        <svg class="w-3 h-3 md:w-4 md:h-4 md:mr-1" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mt-6 flex items-center justify-between">
            <div class="text-sm text-gray-700">
                Showing <span id="showingCount">{{ $applications->count() }}</span> of {{ $applications->count() }}
                applications
            </div>
        </div>
    </div>
