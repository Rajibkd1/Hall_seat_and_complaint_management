                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-blue-700">
                                                ...
                                                (Floor {{ $currentSeat->seat->floor }}, {{ $currentSeat->seat->block }}
                                                Block)
                                            </p>
                            ...
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="text-lg font-semibold text-orange-900">Seat Assignment Required</h4>
                                            <p class="text-orange-700">This approved student needs a seat assignment.</p>
