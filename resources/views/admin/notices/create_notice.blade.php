                        ...
                        <form action="{{ route('admin.notices.store') }}" method="POST" id="createNoticeForm">
                            ...
                            <div class="mb-6">
                                ...
                                <select name="notice_type" 
                                    ...
                                    <option value="deadline" {{ old('notice_type') === 'deadline' ? 'selected' : '' }}>Deadline</option>
                                </select>
                                @error('notice_type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 info-card">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-medium text-gray-900" id="overallProgress">50%</span>
                        </div>
                        <div class="mt-2 bg-gray-200 rounded-full h-2">
                            <div class="bg-blue-600 h-2 rounded-full transition-all duration-300" id="progressBar" style="width: 50%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 info-card">
                    ...
                    <div class="space-y-3">
                        ...
                        <button type="button" onclick="clearForm()" class="w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 flex items-center">
                            <svg class="w-5 h-5 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                            </svg>
                            <span class="text-gray-700">Clear Form</span>
                        </button>
                        <button type="button" onclick="saveAsDraft()" class="w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 flex items-center">
                            <svg class="w-5 h-5 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
