    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-4">
                <a href="{{ route('admin.students') }}" class="hover:text-blue-600 transition-colors duration-200">Students</a>
                        ...
                        <div class="w-32 h-32 rounded-full overflow-hidden bg-white p-1 shadow-lg profile-image">
                            ...
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <span class="text-white text-4xl font-bold">{{ substr($student->name, 0, 1) }}</span>
                                </div>
                            @endif
                        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p class="text-gray-600 mb-6">The student profile you're looking for doesn't exist or has been removed.</p>
            <a href="{{ route('admin.students') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
        ...
        <!-- Back Button -->
        <div class="mt-8">
            <a href="{{ route('admin.students') }}" class="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all duration-200 hover:shadow-md">
