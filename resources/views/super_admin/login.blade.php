...
<head>
    ...
    <title>Super Admin Login - Hall Management System</title>
...
<body class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 min-h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            <div class="w-20 h-20 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                <i class="fas fa-crown text-white text-2xl"></i>
            </div>
            <h2 class="text-3xl font-bold text-gray-800 mb-2">Super Admin</h2>
            <p class="text-gray-600">Access the system administration panel</p>
        </div>
        ...
        <form method="POST" action="{{ route('super_admin.login.submit') }}" class="space-y-6">
            @csrf
            ...
            <button type="submit" 
                    class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105">
        ...
        <div class="mt-8 text-center">
            <p class="text-sm text-gray-600">
                <a href="{{ route('admin.login.page') }}" class="text-indigo-600 hover:text-indigo-800 font-medium">
