...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
    <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-4 md:p-6 shadow-xl animate-slide-up" style="animation-delay: 0.1s;">
    ...
    <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-4 md:p-6 shadow-xl animate-slide-up" style="animation-delay: 0.2s;">
        <div class="flex items-center justify-between">
            <div>
    ...
    <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-4 md:p-6 shadow-xl animate-slide-up" style="animation-delay: 0.3s;">
        <div class="flex items-center justify-between">
            <div>
    ...
    <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-4 md:p-6 shadow-xl animate-slide-up" style="animation-delay: 0.4s;">
        <div class="flex items-center justify-between">
            <div>
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <select id="statusFilter" class="px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-4 mb-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 capitalize">{{ str_replace('_', ' ', $complaint->category) }}</h3>
                                ...
                                <div class="flex items-center justify-between">
                                    <p class="text-sm text-gray-500">
                                        Complaint ID: <span class="font-mono font-medium text-blue-600">#CM-{{ date('Y') }}-{{ str_pad($complaint->complaint_id, 3, '0', STR_PAD_LEFT) }}</span>
                                    </p>
    ...
    <div id="imageModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="relative max-w-4xl max-h-full">
            <img id="modalImage" src="" alt="Complaint Image" class="max-w-full max-h-full object-contain rounded-lg">
