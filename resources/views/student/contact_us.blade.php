        ...
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
            <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-600">University Campus<br>Hall Administration Building<br>City,
                                    State - 12345</p>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <form action="{{ route('student.contact_submit') }}" method="POST" class="space-y-4" id="contactForm">
                        @csrf
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Name</label>
                            <input type="text" id="name" name="name"
                                value="{{ old('name', auth('student')->user()->name ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ old('email', auth('student')->user()->email ?? '') }}" required
