    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="details-card">
                ...
                <div class="detail-row">
                    ...
                    <span
                        class="detail-value">{{ \Carbon\Carbon::parse($application->application_date)->format('F j, Y') }}</span>
                </div>
            ...
            @if ($adminMessage)
                <div class="message-section">
                    ...
                    <div class="message-content">{{ $adminMessage }}</div>
                </div>
            @endif

            <div class="help-section">
                <h3>🤝 Need Assistance?</h3>
                <p>If you have any questions or need further assistance regarding your application, please don't
                    hesitate to contact the administration office.</p>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <div class="disclaimer">
                <strong>📢 Important Notice:</strong> This is an automated message from the NSTU Hall Management System.
                Please do not reply to this email. For any queries or concerns, please contact the administration office
                directly using the contact information provided above.
            </div>
        </div>
    </div>
</body>
